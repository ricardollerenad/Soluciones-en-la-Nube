...
# Verificando del despliegue en vivo 

## PASO N°1
- Abre una terminal y deja ejecutando k9s:

## PASO N°2
- En la terminal abre el *nano deployment.yaml* y cambia las replicas de "1" por "3"
- Aplica el cambio

```bash
kubectl apply -f deployment.yaml
```  
- Mira como cambian en el otro terminal, en la pantalla de K9s, como es que aunmenta las copias de mis contenedores
- Para salir del K9s, basta con precionar "control+C"
